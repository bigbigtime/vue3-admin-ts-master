...
export default defineComponent({
  ...
  setup(props){
    /** 检验用户名 */
    const checkUsername = async (rule: any, value: string, callback: any):Promise<void> => {
      if (!value) {
    ...
    /** 检验密码 */
    const checkPassword = async (rule: any, value: string, callback: any):Promise<void> => {
    ...
    /** 检验重置密码 */
    const checkPasswords = async (rule: any, value: string, callback: any):Promise<void> => {
